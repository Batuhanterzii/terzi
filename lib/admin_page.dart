...
import 'package:terzi/delete_object.dart';
import 'package:terzi/home.dart';
import 'package:terzi/login_page.dart';
                  ...
                  : OutlinedButton(
                      onPressed: () async {
                        ...
                        await firestore
                            ...
                            .doc()
                            .set({
                          'futbolcu-adi': _firstController.text,
                          'futbolcu-fiyati': _secondController.text,
